...
from goblin.exceptions import GoblinGremlinException, GoblinException
...
class GroovyTestModel2(Vertex):
    ...
    get_table_of_models = gremlin.GremlinTable(
        ...
        classmethod=True, defaults={'element_type': 'groovy_test_model2'})


@attr('unit', 'gremlin', 'gremlin_table')
class TestGremlinTable(BaseGoblinTestCase):
...
class TestTableContainer(BaseGoblinTestCase):
