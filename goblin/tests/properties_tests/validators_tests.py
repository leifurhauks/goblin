...
from goblin._compat import print_, PY2
from goblin.tests import BaseGoblinTestCase, testcase_docstring_sub
...
class ValidatorBaseClassTestCase(BaseGoblinTestCase):
